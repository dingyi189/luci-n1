...
m = Map("aria2", translate("Aria2"))

m:section(SimpleSection).template  = "aria2/overview_status"

s = m:section(TypedSection, "aria2")
s.addremove = false
s.anonymous = true
...
o = s:taboption("general", ListValue, "user", translate("Run daemon as user"))
o:value("", translate("aria2"))
...
o = s:taboption("file", Flag, "enable_log", translate("Enable log"))
o.enabled = "true"
o.disabled = "false"
...
o = s:taboption("file", Value, "disk_cache", translate("Disk cache"))
o.rmempty = true

o = s:taboption("file", ListValue, "file_allocation", translate("Preallocation"))
...
o = s:taboption("task", Value, "max_overall_download_limit", translate("Overall download limit"))
o:depends("overall_speed_limit", "1")

o = s:taboption("task", Value, "max_overall_upload_limit", translate("Overall upload limit"))
o:depends("overall_speed_limit", "1")
...
o = s:taboption("task", Value, "max_download_limit", translate("Per task download limit"))
o:depends("task_speed_limit", "1")

o = s:taboption("task", Value, "max_upload_limit", translate("Per task upload limit"))
o:depends("task_speed_limit", "1")

o = s:taboption("task", Value, "max_concurrent_downloads", translate("Max concurrent downloads"))
o.placeholder = "5"

o = s:taboption("task", Value, "max_connection_per_server", translate("Max connection per server"))
o.datatype = "range(1, 16)"
o.placeholder = "1"

o = s:taboption("task", Value, "min_split_size", translate("Min split size"))
o.placeholder = "20M"

o = s:taboption("task", Value, "split", translate("Max number of split"))
o.placeholder = "5"

o = s:taboption("task", Value, "save_session_interval", translate("Autosave session interval"))
o.default = "30"
